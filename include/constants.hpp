...
namespace constants
{
    ...
    const std::string       SOUNDFILE_PORTAL =          "sfx/portal.wav";
    const std::string       SOUNDFILE_SNAKE =           "sfx/snake.wav";
    const std::string       SOUNDFILE_BUTTON_UP =       "sfx/button_up.wav";
    const std::string       SOUNDFILE_BUTTON_DOWN =     "sfx/button_down.wav";
